...
function AnimatedCheck({ delay }: { delay: number }) {
  return (
    <motion.div
      ...
      className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#ff6b6b]/20 to-[#ffb347]/20 border border-[#ff6b6b]/20"
    >
      <Check className="h-3.5 w-3.5 text-[#ff6b6b]" />
    </motion.div>
  );
}
  ...
  return (
    <section className="relative overflow-hidden px-4 py-16 sm:py-28 bg-[#0a0a1a]">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        {/* Pricing cards: PDF + Print side by side */}
        <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-2">
          ...
          >
            ...
            >
              <div className="relative">
                ...
                <span className="relative rounded-full bg-gradient-to-r from-[#ff6b6b] to-[#ffb347] px-5 py-1.5 text-xs font-bold text-white shadow-lg">
                  Популярный выбор
                </span>
              </div>
            </motion.div>
            ...
            {/* Gradient border */}
            <div className="rounded-3xl bg-gradient-to-br from-[#ff6b6b]/50 via-[#a78bfa]/50 to-[#ffb347]/50 p-[1px]">
              <div className="relative overflow-hidden rounded-[23px] bg-[#0f0f2a] p-8">
                {/* Subtle inner glow */}
                ...
                <div className="relative mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-white/60">PDF-книга</span>
                  </div>
                  <div className="flex items-center gap-1 rounded-full border border-[#4ecdc4]/20 bg-[#4ecdc4]/10 px-3 py-1">
                    <Clock className="h-3 w-3 text-[#4ecdc4]" />
                    <span className="text-xs font-medium text-[#4ecdc4]">5 минут</span>
                  </div>
                </div>
                ...
                <div className="relative mb-8 text-center">
                  ...
                  <p className="mt-2 text-sm text-white/30">одна главная роль</p>
                </div>
                ...
                <Link href="/create/start" className="relative block">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group/cta relative w-full overflow-hidden rounded-2xl py-4 text-lg font-bold text-white transition-all duration-300"
                  >
                    {/* Button gradient */}
                ...
                {/* Trust signals */}
                <div className="mt-5 flex items-center justify-center gap-4 text-[11px] text-white/25">
          ...
          >
            ...
            <div className="rounded-3xl border border-white/[0.08] p-[1px]">
              <div className="relative overflow-hidden rounded-[23px] bg-white/[0.03] backdrop-blur-xl p-8">
                {/* Subtle inner glow */}
                ...
                <div className="relative mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Printer className="h-5 w-5 text-[#ffb347]" />
                    <span className="text-sm font-semibold text-white/60">Печатная книга</span>
                  </div>
                  <div className="flex items-center gap-1 rounded-full border border-[#ffb347]/20 bg-[#ffb347]/10 px-3 py-1">
                    <Truck className="h-3 w-3 text-[#ffb347]" />
                    <span className="text-xs font-medium text-[#ffb347]">+ доставка</span>
                  </div>
                </div>
                ...
                <div className="relative mb-8 text-center">
                  ...
                  <p className="mt-2 text-sm text-white/30">включая доставку</p>
                </div>
                  ...
                  {[
                    ...
                    >
                      <motion.div
                        ...
                        className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#ffb347]/20 bg-[#ffb347]/10"
                      >
                ...
                <Link href="/create/start" className="relative block">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="group/cta2 relative w-full overflow-hidden rounded-2xl border border-white/[0.1] bg-white/[0.05] py-4 text-lg font-bold text-white/80 transition-all duration-300 hover:border-white/[0.2] hover:bg-white/[0.08] hover:text-white"
                  >
                    <span className="relative z-10 flex items-center justify-center gap-2">
        ...
        >
          <div className="inline-flex items-center gap-3 rounded-full border border-white/[0.06] bg-white/[0.03] px-6 py-3 backdrop-blur-sm">
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <motion.div
                  key={i}
